function GO16120212330000dat = import2021(filename, dataLines)
%IMPORTFILE1 Import data from a text file
%  GO16120212330000DAT = IMPORTFILE1(FILENAME) reads data from text file
%  FILENAME for the default selection.  Returns the data as a table.
%
%  GO16120212330000DAT = IMPORTFILE1(FILE, DATALINES) reads data for the
%  specified row interval(s) of text file FILENAME. Specify DATALINES as
%  a positive scalar integer or a N-by-2 array of positive scalar
%  integers for dis-contiguous row intervals.
%
%  Example:
%  GO16120212330000dat = importfile1("C:\Users\usuario\Desktop\Renate-files\files\20210821-121416_GO161_2021-233-0000dat.txt", [1, Inf]);
%
%  See also READTABLE.
%
% Auto-generated by MATLAB on 02-May-2023 08:51:53
...
% Import the data
GO16120212330000dat = readtable(filename, opts);
