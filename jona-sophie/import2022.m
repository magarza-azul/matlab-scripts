function Renate1000 = import2022(filename, dataLines)
%IMPORTFILE1 Import data from a text file
%  RENATE1000 = IMPORTFILE1(FILENAME) reads data from text file FILENAME
%  for the default selection.  Returns the data as a table.
%
%  RENATE1000 = IMPORTFILE1(FILE, DATALINES) reads data for the
%  specified row interval(s) of text file FILENAME. Specify DATALINES as
%  a positive scalar integer or a N-by-2 array of positive scalar
%  integers for dis-contiguous row intervals.
%
%  Example:
%  Renate1000 = importfile1("C:\Users\usuario\Desktop\Renate-files\files3\Renate_1000.txt", [1, Inf]);
%
%  See also READTABLE.
%
% Auto-generated by MATLAB on 02-May-2023 11:48:19
...
% Import the data
Renate1000 = readtable(filename, opts);
