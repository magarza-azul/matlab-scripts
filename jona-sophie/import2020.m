function Renate1015 = import2020(filename, dataLines)
%IMPORTFILE1 Import data from a text file
%  RENATE1015 = IMPORTFILE1(FILENAME) reads data from text file FILENAME
%  for the default selection.  Returns the data as a table.
%
%  RENATE1015 = IMPORTFILE1(FILE, DATALINES) reads data for the
%  specified row interval(s) of text file FILENAME. Specify DATALINES as
%  a positive scalar integer or a N-by-2 array of positive scalar
%  integers for dis-contiguous row intervals.
%
%  Example:
%  Renate1015 = importfile1("C:\Users\usuario\Desktop\Renate-files\files\Renate_1015.txt", [1, Inf]);
%
%  See also READTABLE.
%
% Auto-generated by MATLAB on 04-May-2023 08:18:34
...
% Import the data
Renate1015 = readtable(filename, opts);
